...
var ExpectedConstraintError = class extends BaseConstraintError {
  ...
  ${options.stylize("|", "undefined")} `;
    const given = (0, import_node_util.inspect)(this.given, newOptions).replace(/\n/g, padding);
...
var ValidationError = class extends BaseError {
  ...
  [customInspectSymbolStackLess](depth, options) {
    ...
    const padding = `
  ${options.stylize("|", "undefined")} `;
    const given = (0, import_node_util2.inspect)(this.given, newOptions).replace(/\n/g, padding);
...
var ExpectedValidationError = class extends ValidationError {
  ...
  [customInspectSymbolStackLess](depth, options) {
    ...
    const padding = `
  ${options.stylize("|", "undefined")} `;
    const expected = (0, import_node_util3.inspect)(this.expected, newOptions).replace(/\n/g, padding);
    const given = (0, import_node_util3.inspect)(this.given, newOptions).replace(/\n/g, padding);
...
var UnknownPropertyError = class extends BaseError {
  ...
  [customInspectSymbolStackLess](depth, options) {
    ...
    const padding = `
  ${options.stylize("|", "undefined")} `;
    const given = (0, import_node_util4.inspect)(this.value, newOptions).replace(/\n/g, padding);
...
var MultiplePossibilitiesConstraintError = class extends BaseConstraintError {
  ...
  [customInspectSymbolStackLess](depth, options) {
    ...
    const padding = `
  ${verticalLine} `;
    const given = (0, import_node_util5.inspect)(this.given, newOptions).replace(/\n/g, padding);
