...
var ExpectedValidationError = class extends ValidationError {
  ...
  [customInspectSymbolStackLess](depth, options) {
    ...
    const padding = `
  ${options.stylize("|", "undefined")} `;
    const expected = inspect3(this.expected, newOptions).replace(/\n/g, padding);
    const given = inspect3(this.given, newOptions).replace(/\n/g, padding);
...
var UnknownPropertyError = class extends BaseError {
  ...
  [customInspectSymbolStackLess](depth, options) {
    ...
    const padding = `
  ${options.stylize("|", "undefined")} `;
    const given = inspect4(this.value, newOptions).replace(/\n/g, padding);
...
var MultiplePossibilitiesConstraintError = class extends BaseConstraintError {
  ...
  [customInspectSymbolStackLess](depth, options) {
    ...
    const padding = `
  ${verticalLine} `;
    const given = inspect5(this.given, newOptions).replace(/\n/g, padding);
